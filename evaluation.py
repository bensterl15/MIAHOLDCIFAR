...
def get_inception_model(inceptionv3=False):
    if inceptionv3:
        ...
        return tfhub.load('/home/shi/meatball/CLD-SGM-main/inceptions/imagenet_inception_v3_feature_vector_5/')
        #return tfhub.load('/home/shi/meatball/CLD-SGM-main/inceptions/imagenet_inception_v3_feature_vector_5/')
    else:
        #return tfhub.load(INCEPTION_TFHUB)
        #return tfhub.load('/home/shi/meatball/CLD-SGM-main/inceptions/tfgan_eval_inception_1/')
        return tfhub.load('/data/shi/meatball/inceptions/tfgan_eval_inception_1/')
'''
